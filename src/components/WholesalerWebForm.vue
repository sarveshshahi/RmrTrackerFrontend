        ...
        <CCol :sm="12">
          <form @submit.prevent="submitForm" class="competition-form">
            ...
            <CRow class="mt-2">
              ...
              <CCol md="9">
                <select v-model="selectedTown" class="form-select" @change="onTownChange">
            ...
            <CRow class="mt-2">
              <CCol md="3">
                <CFormLabel for="brand-name">Wholesaler Outlet Name:<span style="color: red">*</span></CFormLabel>
              </CCol>
              <CCol md="9">
                <select v-model="selectedWholesalerOutletName" @change="onSelectedWholesalerOutletName"
                  class="form-select">
                  <!-- make an API to fetch wholesalers in the area based on selected state and district
                and put the values in dropdown -->
                  <option disabled inactive value="">Wholesaler Name</option>
                  <option v-for="wholesaler in wholesalerOutlets" :key="wholesaler.Wholesaler_Id" :value="wholesaler">
            ...
            <CRow class="mt-2">
              <CCol md="3">
                <CFormLabel for="brand-name">Beat ID:<span style="color: red">*</span></CFormLabel>
              </CCol>
              <CCol md="9">
                <span>
                  <CFormInput v-model="beatIdofSelectedWholesaler" readonly />
                </span>
              </CCol>
              <!-- <CCol :xs="3">
                    <button @click="addBrand" class="btn btn-success">
            ...
            <CRow class="mt-2">
              <CCol md="3">
                <CFormLabel for="brand-name">Wholesaler ID:<span style="color: red">*</span></CFormLabel>
              </CCol>
              <CCol md="9">
                <span>
                  <CFormInput v-model="wholesalerId" readonly />
                </span>
              </CCol>
              <!-- <CCol :xs="3">
                    <button @click="addBrand" class="btn btn-success">
            ...
            <CRow class="mt-2">
              <CCol md="3">
                <CFormLabel for="">IC per MC<span style="color: red">*</span></CFormLabel>
              </CCol>
              <CCol md="9">
                <CFormInput type="number" class="form-control" v-model="ICPerMC" required
                  oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                </CFormInput>
              </CCol>
            </CRow>
            ...
            <CRow class="mt-2">
              <CCol md="3">
                <CFormLabel for="units-in-ic">IC WLP:<span style="color: red">*</span></CFormLabel>
              </CCol>
              <CCol md="9">
                <CFormInput type="text" class="form-control" v-model="icWLP" required
                  oninput="this.value = this.value.replace(/[^0-9]/g, '');">
                </CFormInput>
              </CCol>
            </CRow>
...
export default {
  ...
  methods: {
    ...
    async autofillFields(data) {
      ...
      await this.fetchWholesalerData();
      // this.onBrandChange();
    ...
    // );
    // this.selectedBrandId = selectedBrandData ? selectedBrandData.id : null;

    // if (this.selectedBrandId) {
    //   axios
    //     .get(`${process.env.VUE_APP_ROOT_API}/api/netweightmaster/${this.selectedBrand}`)
    //     .then((response) => {
        ...
        try {
          const formData = {
            ...
            wholesaler_outlet_name:
              this.selectedWholesalerOutletName.Wholesaler_Outlet_Name,
            beat_id: this.beatIdofSelectedWholesaler,
            wholesaler_id: this.wholesalerId,
            ic_per_mc: this.ICPerMC,
            ic_wlp: this.icWLP,
            type: "Wholesaler",
          };
